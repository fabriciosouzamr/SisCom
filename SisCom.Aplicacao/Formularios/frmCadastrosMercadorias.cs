...
{
    public partial class frmCadastrosMercadorias : Form
    {
        public frmCadastrosMercadorias()
        {
            InitializeComponent();
        ...
        private async void Inicializar()
        {
            ...
            Combo_ComboBox.Formatar(comboGrupoProduto, 
                                    ...
                                    await grupoController.Combo());
            //Combo_ComboBox.Formatar(comboFornecedor,
            //                        "ID", "Nome",
            //                        ComboBoxStyle.DropDownList,
            //                        await (new PessoaController()).ComboFornecedor());
        }
        ...
        {
            (new frmCadastrosFabricante()).ShowDialog();
        }

        private void botaoGrupoProduto_Click(object sender, EventArgs e)
        {
            (new frmCadastrosGrupo()).ShowDialog();
        }
