...
namespace SisCom.Aplicacao.Formularios
{
    public partial class frmCadastroTipoCliente : FormMain
    {
        ...
        private async void Inicializar()
        {
            ...
            Grid_DataGridView.DataGridView_ColunaAdicionar(dataTipoCliente, "ID", "ID", TipoColuna.TextBox, 0);
            Grid_DataGridView.DataGridView_ColunaAdicionar(dataTipoCliente, "Nome", "Nome", TipoColuna.TextBox, 400, Declaracoes.CampoNome_Caracteres);
            GridAtualizar();
        }
