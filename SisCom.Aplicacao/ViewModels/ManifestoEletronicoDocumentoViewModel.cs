...
namespace SisCom.Aplicacao.ViewModels
{
    public class ManifestoEletronicoDocumentoViewModel
    {
        ...
        public virtual List<ManifestoEletronicoDocumentoNotaViewModel> ManifestoEletronicoDocumentoNotas { get; set; }
        public virtual List<ManifestoEletronicoDocumentoPercursoViewModel> ManifestoEletronicoDocumentoPercursos { get; set; }
