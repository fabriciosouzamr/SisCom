...
namespace DanfeSharp
{
    internal class DanfePagina
    {
        ...
        public String sRodade { get; private set; }

    public DanfePagina(Danfe danfe, String Rodape = "")
        {
        ...
        public void DesenharCreditos()
        {
            ...
            {
                Gfx.DrawString(sRodade, RetanguloCreditos, Danfe.EstiloPadrao.CriarFonteItalico(6), AlinhamentoHorizontal.Direita);
            }
        }
        ...
        public void DesenharAvisoCancelada()
        {
            RectangleF RetanguloCorpoLocal = new RectangleF(RetanguloCorpo.X, RetanguloCorpo.Y - 15, RetanguloCorpo.Width, RetanguloCorpo.Height);

            TextStack ts = new TextStack(RetanguloCorpoLocal) { AlinhamentoVertical = AlinhamentoVertical.Centro, AlinhamentoHorizontal = AlinhamentoHorizontal.Centro, LineHeightScale = 0.9F }
                        .AddLine("SEM VALOR FISCAL", Danfe.EstiloPadrao.CriarFonteRegular(48))
                        .AddLine("NF-e Cancelada", Danfe.EstiloPadrao.CriarFonteRegular(30));
        ...
        public void DesenharAvisoNaoAutorizado()
        {
            ...
            TextStack ts = new TextStack(RetanguloCorpoLocal) { AlinhamentoVertical = AlinhamentoVertical.Centro, AlinhamentoHorizontal = AlinhamentoHorizontal.Centro, LineHeightScale = 0.9F }
                        .AddLine("NF-e sem Autorização", Danfe.EstiloPadrao.CriarFonteRegular(48))
                        .AddLine("de Uso da SEFAZ", Danfe.EstiloPadrao.CriarFonteRegular(30));

            Gfx.PrimitiveComposer.BeginLocalState();
            Gfx.PrimitiveComposer.SetFillColor(new org.pdfclown.documents.contents.colorSpaces.DeviceRGBColor(0.77, 0.77, 0.77));
            ts.Draw(Gfx);
            Gfx.PrimitiveComposer.End();
        }
