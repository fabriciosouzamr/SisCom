...
namespace DanfeSharp
{
    public class Danfe : IDisposable
    {
        ...
        public bool ImprimirCancelado { get; set; }
        ...
        {
            DanfePagina p = new DanfePagina(this, Rodape);
            ...
            {
                if (p.Danfe.ImprimirCancelado)
                {
                    p.DesenharAvisoCancelada();
                }
                else
                {
                    if (!ViewModel.ProtocoloAutorizado)
