...
{
    public partial class MDFe : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UltimoNumeroManifestoEletronicoDocumento = table.Column<string>(type: "varchar(10)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoTransportador = table.Column<int>(type: "int", nullable: true),
                    ...
                    DadoVeiculo_CapacidadeM3 = table.Column<double>(type: "float", nullable: false, defaultValue: 0.0),
                    DadoVeiculo_TipoRodado = table.Column<int>(type: "int", nullable: true),
                    DadoVeiculo_TipoCarroceria = table.Column<int>(type: "int", nullable: true),
                    ...
                    DadoVeiculoVeiculoTerceiros_TipoProprietario = table.Column<int>(type: "int", nullable: true),
                    ...
                    UnidadePeso = table.Column<int>(type: "int", nullable: true),
                    ...
                    Condutor_CPF = table.Column<string>(type: "varchar(14)", nullable: true),
                    ...
                    ManifestoEletronicoDocumentoSerieId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ManifestoEletronicoDocumentoSerieId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManifestoEletronicoDocumentoId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
