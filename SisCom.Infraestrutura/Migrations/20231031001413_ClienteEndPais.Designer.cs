...
namespace SisCom.Infraestrutura.Migrations
{
    ...
    [Migration("20231031001413_ClienteEndPais")]
    partial class ClienteEndPais
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SisCom.Entidade.Modelos.Condutor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SisCom.Entidade.Modelos.Empresa", b =>
                {
                    ...
                    b.Property<string>("NFE_InfComple_CreditoSimplesNacional")
                        .HasColumnType("varchar(1000)");

                    b.Property<string>("NFE_InfComple_TributosTotal")
                        .HasColumnType("varchar(1000)");
                    ...
                    b.Property<int?>("NuvemFiscal_TipoEmirssor")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SisCom.Entidade.Modelos.EstoqueLancamento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SisCom.Entidade.Modelos.FiscalEstadoIcms", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SisCom.Entidade.Modelos.Mercadoria", b =>
                {
                    ...
                    b.HasIndex("Estoque_UnidadeMedidaId");
                    ...
                    b.OwnsOne("SisCom.Entidade.Modelos.Endereco", "Endereco", b1 =>
                        {
                            ...
                            b1.Property<Guid?>("End_PaisId")
                                .HasColumnType("uniqueidentifier")
                                .HasColumnName("End_PaisId");
                            ...
                            b1.HasOne("SisCom.Entidade.Modelos.Pais", "End_Pais")
                                .WithMany()
                                .HasForeignKey("End_PaisId");

                            b1.Navigation("End_Cidade");

                            b1.Navigation("End_Pais");
                        });
            ...
            modelBuilder.Entity("SisCom.Entidade.Modelos.EstoqueLancamento", b =>
                {
                    b.HasOne("SisCom.Entidade.Modelos.Estoque", "Estoque")
                        .WithMany()
            ...
            modelBuilder.Entity("SisCom.Entidade.Modelos.Mercadoria", b =>
                {
                    ...
                    b.HasOne("SisCom.Entidade.Modelos.UnidadeMedida", "Estoque_UnidadeMedida")
                        .WithMany()
                        .HasForeignKey("Estoque_UnidadeMedidaId");
                    ...
                    b.Navigation("Estoque_UnidadeMedida");
